...
@implementation JKMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [JKMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [JKMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [JKMessageTextView maxCharactersPerLine]) + 1;
}
